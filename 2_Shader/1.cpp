...
int main(){
    ...
    readFile("./shaders/1.vs", vshaderSource);
    std::string fshaderSource;
    readFile("./shaders/1.fs", fshaderSource);
    ...
    GLuint u_color_loc = glGetUniformLocation( program, "u_color");
    glUniform4f( u_color_loc, 0.3, 0.4, 0.7, 1.0);
